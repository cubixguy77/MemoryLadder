...
class Scoring {
    ...
    static int[] getScore(int gameType, String[][] guess, String[][] answer) {
        switch (gameType) {
            case LISTS_EVENTS:
                return getScore_HISTORICAL_DATES(guess, answer);
            case SHAPES_FACES:
                return getScore_NAMES_FACES(guess, answer);
            case SHAPES_ABSTRACT:
                return getScore_ABSTRACT_IMAGES(guess, answer);
            case CARDS_LONG:
                return getScore_LONG_CARDS_WMC(guess, answer);
            default:
                return null;
        }
    }

    static int[] getScore(String[][] guess, String[][] answer, int columnsize) {
        return getScore_RANDOM_WORDS(guess, answer, columnsize);
    }

    static int[] getScore(int gameType, char[][] guess, char[][] answer) {
        switch (gameType) {
            case NUMBERS_SPEED:
            ...
            case NUMBERS_BINARY:
                return getScore_StringArray_ByRow(guess, answer);
            case NUMBERS_SPOKEN:
                return getScore_SPOKEN_NUMBERS(guess, answer);
            default:
                return null;
        }
    }
    ...
    private static int[] getScore_SPOKEN_NUMBERS(char[][] guess, char[][] answer) {
    ...
    private static int[] getScore_RANDOM_WORDS(String[][] guess, String[][] answer, int columnsize) {
        return getScore_StringArray_ByColumn(toLowerCase(guess), toLowerCase(answer), true, columnsize);
    }

    private static int[] getScore_HISTORICAL_DATES(String[][] guess, String[][] answer) {
    ...
    private static int[] getScore_LONG_CARDS_WMC(String[][] guess, String[][] answer) {
    ...
    private static int[] getScore_NAMES_FACES(String[][] guess, String[][] answer) {
    ...
    /* untested */
    private static Boolean withinThreeChars(String guess, String answer) {
    ...
    /* untested */
    private static int[] getScore_ABSTRACT_IMAGES(String[][] guess, String[][] answer) {
        double numCorrect;
        double numBlank = 0;
        double TotalScore = 0;
        int numRows = guess.length;
     ...
     */
    private static int[] getScore_StringArray_ByColumn(String[][] guess, String[][] answer, Boolean checkSpelling, int columnsize) {
    ...
    private static int lastAttemptedColumn(String[][] guess, String blank, int columnsize) {
        int numRows = guess.length;
        int numCols = guess[0].length;
        int numPages = numRows / columnsize;
    ...
    private static int lastAttemptedRow(String[][] guess, String blank) {
    ...
    private static Boolean attemptedRow(String[] row, String blank) {
        for (String aRow : row) {
            if (!aRow.equals(blank))
                return true;
        }
        return false;
    }
    ...
    private static Boolean attemptedDeck(String[] deck) {
        for (String aDeck : deck) {
            if (!aDeck.equals("card_xx"))
                return true;
        }
        return false;
    }
    ...
    private static int[] getScore_StringArray_ByRow(char[][] guess, char[][] answer) {
    ...
    private static String[][] toLowerCase(String[][] array) {
