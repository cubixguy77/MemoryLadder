...
public class CardSettings implements Parcelable {
    ...
    public CardSettings(int numDecks, int deckSize, int numCardsPerGroup, boolean shuffle, boolean isMnemonicsEnabled) {
