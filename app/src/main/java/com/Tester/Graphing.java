...
//	private static int draw_only_this_idx = -1;
    ...
    public Graphing(int width, int height, String[] scores) {
    	this.width = width;
    	this.height = height;
    	this.scores = scores;
    }
    ...
    public Bitmap quicky_XY(Bitmap bitmap, String[] scores)
	  {
  ...
  public void  draw_the_grid(Canvas this_g)  {
      int left_margin_d;
  ...
  public void print_axis_values_4_grid(Canvas thisDrawingArea, String cur_units , String cur_max , String cur_min , int  x_guide)  {
	    String this_str;
  ...
  public boolean plot_array_list(Canvas this_g, String[] this_array_list , String this_title , int only_this_idx ) 
  {
           int lRow ;
           int points_2_plot ; 
           int prev_x, prev_y ;
...
{                	 
  ...
  public double get_ceiling_or_floor(double this_val ,  boolean is_max  )
  {
